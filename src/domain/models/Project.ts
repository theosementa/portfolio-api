...
export class ProjectData {
  static cashflow: Project = {
    ...
    frameworks: [
      FrameworkData.swiftUI,
      FrameworkData.charts,
      FrameworkData.storeKit,
      FrameworkData.appIntents,
      FrameworkData.coreData,
      FrameworkData.cloudKit,
      FrameworkData.visionKit,
      FrameworkData.userNotifications,
      FrameworkData.googleSignIn,
      FrameworkData.authenticationServices,
    ],
  };
  ...
  static cyclo: Project = {
    ...
    frameworks: [
      FrameworkData.swiftUI,
      FrameworkData.healthKit,
      FrameworkData.weatherkit,
      FrameworkData.mapKit,
      FrameworkData.charts,
      FrameworkData.coreData,
    ],
  };
  ...
  static ecoTime: Project = {
    ...
    frameworks: [
      FrameworkData.swiftUI,
      FrameworkData.deviceActivity,
      FrameworkData.familyControls,
      FrameworkData.managedSettings,
    ],
  };
  ...
  static split: Project = {
    ...
    frameworks: [
      ...
      FrameworkData.googleSignIn,
      FrameworkData.authenticationServices,
      FrameworkData.lottie,
      FrameworkData.socketIO,
      FrameworkData.photoUI,
      FrameworkData.storeKit,
    ],
  };
  ...
  static portfolio: Project = {
    ...
    languages: [
      ...
      TechLanguageData.javascript,
      TechLanguageData.html,
      TechLanguageData.css,
    ],
    frameworks: [],
  };
